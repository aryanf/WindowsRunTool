...
for key_command in key_commands:
    bat_file_path = os.path.join(current_directory, f'{key_command}.bat')
    shortcut_file_path = os.path.join(current_directory, f'{key_command}.lnk')
    python_script_path = os.path.join(current_directory, 'python', 'run.py')
    directory_path = os.path.join(current_directory, 'python', key_command)
...
'''
        ...
        print(f'Successfully created bat and shortcut in {current_directory}.')
