...
def main(message: MainCommandMessage):
    '''
Stopwatch 
{switch_1}: Unit time like d, day, days, h, hour, hours, m, minute, minutes, s, sec, second, seconds. Default is hour
...
'''
    ...
    units = ['d', 'day', 'days', 'h', 'hour', 'hours', 'm', 'minute', 'minutes', 's', 'sec', 'second', 'seconds']
